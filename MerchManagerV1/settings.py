...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Where collectstatic collects static files to
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Ensure your static files are here
]
